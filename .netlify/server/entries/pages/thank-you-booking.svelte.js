...
const Thank_you_booking = (0, import_index_ebf9217c.c)(($$result, $$props, $$bindings, slots) => {
  return `${(0, import_index_ebf9217c.v)(import_thank_you_306b0bba.T, "ThankYouPage").$$render(
    $$result,
    {
      message: "Thanks for booking a time with us! You will receive a confirmation email with more details on your meeting.",
