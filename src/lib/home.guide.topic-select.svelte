...
<div class="relative mx-auto flex  w-full max-w-screen-2xl flex-col items-center justify-center md:pb-12 lg:flex-row" id="guide-container">
	<div
		class="mx-auto mb-10 flex w-full max-w-screen-sm flex-col items-center justify-center border-1 border-white/50 bg-analogBlack-300 bg-gameGrid py-10  px-1 shadow-button shadow-white/10 lg:mb-0 lg:w-1/2 lg:max-w-none lg:py-10 lg:px-10 xl:w-[40%] xl:py-16 xl:px-10"
		id="guide-buttons"
	>
		...
		{#each DATA as topic, i}
			{#if selected === i}
				<div class="mr-5 animate-fadeIn">
					...
					<p class="pb-10 italic text-white">
						{topic.qualifier}
					</p>
