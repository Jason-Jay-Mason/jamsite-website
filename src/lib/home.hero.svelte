<script>
	...
	let messages = ['ranks higher.', 'loads faster.', 'looks nicer.', 'wins more business.'];
</script>

<div class="z-0 relative bg-analogBlack-300 w-full h-auto md:h-screen md:min-h-hero bg-gameGrid">
	<div
		class="container py-28 px-2  mx-auto flex justify-center items-center h-full flex-col text-center max-w-3xl"
	>
		<h1
			class="text-3xl sm:text-5xl md:text-7xl font-bold leading-normal md:leading-normal sm:leading-normal pb-9"
		>
